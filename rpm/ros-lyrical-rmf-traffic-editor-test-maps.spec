...
%global pkg_name rmf_traffic_editor_test_maps
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rmf-traffic-editor-test-maps
Version:        1.14.1
Release:        1%{?dist}
...
%changelog
* Fri Sep 25 2026 Morgan Quigley <morgan@openrobotics.org> - 1.14.1-1
- Autogenerated by Bloom

* Wed Apr 29 2026 Morgan Quigley <morgan@openrobotics.org> - 1.14.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Morgan Quigley <morgan@openrobotics.org> - 1.14.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Morgan Quigley <morgan@openrobotics.org> - 1.14.0-1
- Autogenerated by Bloom
